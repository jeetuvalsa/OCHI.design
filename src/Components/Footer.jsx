...
function Footer() {
  return (
    <div className="w-full h-screen px-20 flex items-center justify-center">
      <div className="left w-1/2 h-full   py-28 flex items-start justify-between flex-col">
        <h1 className="text-[9vw] font-[hero] uppercase  leading-[7vw]">
          Eye- <br />
          opening
        </h1>
        <span>
      ...
      <div className="right w-1/2 h-full py-28 ">
        <h1 className="text-[9vw] font-[hero] uppercase  leading-[7vw]">
          Presentations
        </h1>
        <div className="Badaright py-14 flex items-center justify-between">
          <div className="chotaleft">
            {[
              "S:",
              "Instagram",
              "Behance",
              ...
              <h1
                ...
                className={`text-[1.2vw]  ${
                  (index == 6 || index == 7) && "w-[14vw] mt-7"
                } font-[top] ${
                  (index == 0 || index == 5 || index == 8) && "mb-7 mt-5"
                }`}
              >
                {item}
              </h1>
          ...
          <div className="chotaright">
            {[
              ...
              <h1
                key={index}
                className={`text-[1.2vw] ${index == 0 && "mb-5"} font-[top]`}
              >
                {item}
              </h1>
            ))}
